  ...
  return (
    <div className="p-6">
      ...
      <p className="text-gray-600 mb-6">
        Welcome, Doctor! You can manage patients and create reports.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h3 className="text-xl font-semibold text-gray-700 mb-2">Manage Reports</h3>
          <p className="text-gray-600">
            Create and manage reports for patient care.
          </p>
          <a href="/reports" className="mt-4 inline-block bg-blue-600 text-white p-2 rounded hover:bg-gray-700">
            Go to Reports
          </a>
        </div>
      </div>
